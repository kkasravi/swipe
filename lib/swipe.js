  ...
  (function(require, exports, moduleId) {
    ...
    var Swipe = (function() {
      function Swipe() {
        ...
        var ul = p_vars.ul;
        Object.getOwnPropertyDescriptor(this,'ul') || Object.defineProperty(this,'ul', {get: function(){return ul;},set: function(e){ul=e;}});
        ...
        var ctor = function (_properties) {
          ...
          this.slider=properties.element;
          this.ul=this.slider.children[0];
          this.slider.style.overflow='hidden';
          this.ul.style.listStyle='none';
          this.setup();
          this.begin();
          this.ul.addEventListener('touchstart',this.onstart,false);
          this.ul.addEventListener('touchmove',this.onmove,false);
          this.ul.addEventListener('touchend',this.onend,false);
          this.ul.addEventListener('webkitTransitionEnd',this.ontransitionend,false);
          this.ul.addEventListener('transitionend',this.ontransitionend,false);
      ...
      Swipe.prototype['setup'] = function() {
        monads.DOMable({
          tagName:'nav'
        }).on('load').insert(this.slider.parentNode).add(monads.DOMable({
          tagName:'span'
        }).on('load').attributes({
          id:'position'
        }).add(monads.DOMable({
        ...
        this.width=("getBoundingClientRect" in this.slider)?this.slider.getBoundingClientRect().width:this.slider.offsetWidth;
        if(!this.width) {
          return null;
        }
        this.slider.style.visibility='hidden';
        this.ul.style.width=(this.slides.length * this.width) + 'px';
      ...
      Swipe.prototype['onstart'] = function(e) {
        ...
        this.deltaX=0;
        this.ul.style.webkitTransitionDuration=0;
        e.stopPropagation();
      };
      Swipe.prototype['onmove'] = function(e) {
        ...
        if(!this.isScrolling) {
          ...
          this.ul.style.webkitTransform='translate3d(' + (this.deltaX - this.index * this.width) + 'px,0,0)';
          e.stopPropagation();
        }
      };
      ...
      Swipe.init = (function () {
        var styles=[{
          ...
          selector:'.dot',
          style:"display: inline-block;margin:10px 3px;width:12px;height:12px;border-radius:6px;background-color:#8999A6;"
        },{
          selector:'.active',
